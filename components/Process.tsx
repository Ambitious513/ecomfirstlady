...
export default function Process() {
  ...
  return (
    <section
      id="process"
      className="bg-[#0D0F0D] py-24 lg:py-32"
        ...
        <div className="grid md:grid-cols-4 gap-px bg-white/5">
          {steps.map((step, i) => (
            <motion.div
              ...
              className="bg-[#0D0F0D] p-8 flex flex-col gap-4 relative group"
            >
              ...
              <p className="text-white/45 leading-[1.75]" style={{ fontSize: "0.875rem" }}>
                {step.body}
              </p>
